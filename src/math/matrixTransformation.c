...
static void cross(const GLfloat *a, GLfloat *b, GLfloat *out){
...
void  scale(GLfloat *out, GLfloat *in, const GLfloat* v){
    GLfloat S[16];
...
void lookAt(GLfloat *out, const GLfloat *eye, const GLfloat *center, const GLfloat *up){
    GLfloat f[3] = {center[0] - eye[0], center[1] - eye[1], center[2] - eye[2]};
    normalize(f);
