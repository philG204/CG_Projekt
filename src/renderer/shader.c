...
GLuint shader_init(char* objDir){
    ...
    const char vertexShaderPath[512];
    snprintf(vertexShaderPath, sizeof(vertexShaderPath), "assets/%s/Shaders/vertexShader.vs", objDir);
    ...
    const char fragmentShaderPath[512];
    snprintf(fragmentShaderPath, sizeof(fragmentShaderPath), "assets/%s/Shaders/fragmentShader.vs", objDir);
